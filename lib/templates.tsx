...
export const EmploymentApplicationTemplate: FC<{ formData: z.infer<typeof employmentFormSchema> }> = ({
  formData,
}) => (
  <div>
    ...
    <h2>Eligibility</h2>
    <p><strong>18 Years or Older:</strong> {formData.is18YearsOld}</p>
    <p><strong>Currently Employed:</strong> {formData.isEmployed}</p>
    ...
    <p><strong>Special License/Certification:</strong> {formData.specialLicenseOrCertification}</p>
    
    <h2>Work History</h2>
    <h3>Most Recent Position</h3>
    <p><strong>Company:</strong> {formData.companyName1}</p>
    <p><strong>Position:</strong> {formData.position1}</p>
    <p><strong>Duration:</strong> {formData.startDate1?.toLocaleDateString() || 'Not provided'} - {formData.endDate1?.toLocaleDateString() || 'Not provided'}</p>
    
    <h3>Previous Position</h3>
    <p><strong>Company:</strong> {formData.companyName2}</p>
    <p><strong>Position:</strong> {formData.position2}</p>
    <p><strong>Duration:</strong> {formData.startDate2?.toLocaleDateString() || 'Not provided'} - {formData.endDate2?.toLocaleDateString() || 'Not provided'}</p>
    
    <h3>Additional Position</h3>
    <p><strong>Company:</strong> {formData.companyName3}</p>
    <p><strong>Position:</strong> {formData.position3}</p>
    <p><strong>Duration:</strong> {formData.startDate3?.toLocaleDateString() || 'Not provided'} - {formData.endDate3?.toLocaleDateString() || 'Not provided'  }</p>
