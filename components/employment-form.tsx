...
export function EmploymentForm() {
  ...
  async function onSubmit(values: z.infer<typeof employmentFormSchema>) {
    try {
      await sendEmploymentApplication(values);
      form.reset();
      setSubmitted(true);
    } catch (error) {
      ...
      <Card className="bg-muted/40">
        <Empty>
          <EmptyHeader>
            ...
            <EmptyTitle>Application Submitted</EmptyTitle>
            <EmptyDescription>Your application has been submitted successfully.</EmptyDescription>
          </EmptyHeader>
        </Empty>
      </Card>
    );
  ...
  return (
    <Card className="bg-muted/40">
      <CardHeader>
        <CardTitle className="text-2xl text-center">Employment Application</CardTitle>
      </CardHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <FormLabel>Are you 18 years of age or older?</FormLabel>
                      <FormControl>
                        <RadioGroup
                ...
                <FormField
                  control={form.control}
                  name="isLegallyEligible"
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <FormLabel>Are you legally eligible to work in the United States?</FormLabel>
                      <FormControl>
                        <RadioGroup
                          onValueChange={field.onChange}
                          defaultValue={field.value}
                ...
                <FormField
                  control={form.control}
                  name="isFelonOrMisdemeanant"
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <FormLabel>
                        Have you ever been convicted of a felony or misdemeanor in the past 7 years?
                      </FormLabel>
                      <FormControl>
                        <RadioGroup
                          onValueChange={field.onChange}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <FormField
                  control={form.control}
                  name="specialLicenseOrCertification"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Special Licenses or Certifications</FormLabel>
                      <FormControl>
                        <Input {...field} placeholder="RN License, CNA Certification, etc." />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <h4 className="font-medium">Most Recent Position</h4>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Rochester General Hospital" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Position</FormLabel>
                          <FormControl>
                            <Input placeholder="Licensed Practical Nurse" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                ...
                {/* Additional Position */}
                <div className="space-y-4">
                  <h4 className="font-medium">Additional Position</h4>
                  <div className="grid grid-cols-1 gap-4">
                    <FormField
                      control={form.control}
                      name="companyName3"
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Company Name</FormLabel>
                          <FormControl>
                            <Input placeholder="Strong Memorial Hospital" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Position</FormLabel>
                          <FormControl>
                            <Input placeholder="Certified Nursing Assistant" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
