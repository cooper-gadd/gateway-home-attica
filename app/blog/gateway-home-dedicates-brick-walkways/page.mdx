...
export const metadata = {
  ...
  description:
    "A meaningful dedication ceremony for memorial brick walkways honoring Gateway Home residents.",
  date: "2024-07-13",
  alternates: {
...
<BlogHeader title="Gateway Home Dedicates Brick Walkways" author="Brain Quinn" />
...
<BlogImage src="/sara.jpg" alt="Sara Brunner" caption="Sara Brunner, Gateway Home Director" />
