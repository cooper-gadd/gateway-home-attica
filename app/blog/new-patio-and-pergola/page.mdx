...
export const metadata = {
  ...
  description:
    "A new community project bringing comfort to Gateway Home residents and their families.",
  date: "2022-09-01",
  alternates: {
...
<BlogHeader title="New Patio and Pergola" author="Nathan Montford" />
...
<BlogImage src="/truck.jpg" alt="Truck" caption="Project preparations begin" />
...
<BlogImage src="/pouring.jpg" alt="Pouring" caption="Pouring the decorative concrete pad" />
...
<BlogImage src="/roof.jpg" alt="Roof" caption="Construction of the pergola" />
...
<BlogImage src="/final.jpg" alt="Final" caption="The completed patio and pergola project" />
