...
const donors = {
  ...
  silver: [
    ...
    "Merlyn & Denise Bissell",
    "County Line Stone Co., Inc.",
    "Charlie Evans",
    "Jim & Sandy Ewert",
    "Foss Livestock, LLC",
    "Todd Hartman",
    "Joseph & Susan McPherson",
    "Joseph & Carol Pilc",
  ...
  community: [
    ...
    "Mooch & Shellie Acquard",
    "Attica Rodeo Show & Association, Inc.",
    "James E. & Marie J. Barrett",
    "Gary & Carol Barrow",
    "Norma Bartz",
    ...
    "Nancy A. Cross",
    "Michael & Barbara Crowley",
    "David & Nancy Dimick",
    "Alfred & Annette Doktor",
    "Edward & Paula Donnelly",
    "Jerry & Sue Elmore",
    "Kevin & Dawn Fisher",
    ...
    "Evelyn Mager",
    "Virginia Mainus",
    "Jeffrey & Barbara Manning",
    "William & Jo Marie McMullen",
    "Randall Meidenbauer",
    "Matthew & Mary Hauslauer Mest",
    "Dan & Brenda Miller",
    "Margaret Morrissey",
    "Gina M. Morrison",
    "David Newton",
    ...
    "Eric & Eleanor Randall",
    "John & Patricia Reiner",
    "Robert W. Reyes Jr.",
    "James & Kristie Rohauer",
    "Gerald & Patricia Romesser",
    "Janet Romesser",
    ...
    "St. John Neumann RC Church of Wyoming County",
