  ...
  return (
    <main className="container mx-auto px-4 py-24">
      <div className="max-w-3xl mx-auto text-center mb-12">
        <h1 className="text-4xl font-bold mb-4">Careers at Gateway Home</h1>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              <p className="text-lg mb-6">
                At Gateway Home, we value our employees as much as we value our
                residents. We offer competitive compensation, comprehensive
                benefits, and opportunities for professional growth. Our
                collaborative work environment supports both personal and
                professional development.
              </p>
              <p className="text-lg">
                We&apos;re looking for passionate individuals who share our
                commitment to providing exceptional care. Join our team and make
                a meaningful impact while building a rewarding career in
                healthcare.
              </p>
            </div>
            <div className="md:w-1/2">
