    ...
    <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
      <div className="grid grid-cols-1 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <p className="leading-7 [&:not(:first-child)]:mt-6">
              ...
              immersive program is designed to empower caregivers with the
              skills and wisdom to offer compassionate support to those nearing
              the end of life. The class will take place every Wednesday for
              eight consecutive weeks, providing both practical and spiritual
              tools to help those in their final days live fully until they
              pass.
            </p>
            <p className="leading-7 [&:not(:first-child)]:mt-6">
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
              This training will be an in-depth exploration of what it means to
              be a supportive presence in the dying process. Our sessions will
              include:
            </p>
            <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
              <li>
                <strong>Creating Sacred Space for the Dying: </strong>Learn how
                to transform the environment into a sanctuary that fosters peace
                and comfort for those transitioning.
              </li>
              <li>
                <strong>Holding Space: </strong>Develop the ability to sit with
                others in their most vulnerable moments, offering quiet,
                attentive presence without the need to &quot;fix&quot; anything.
              </li>
              <li>
              ...
              <li>
                <strong>Preserving Precious Memories: </strong>Delve into
                methods for documenting and safeguarding the stories and moments
                that define a life, creating cherished keepsakes for loved ones
                to hold onto.
              </li>
              <li>
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
              This training will be transformative for caregivers who feel
              called to accompany others during life’s final chapter. Whether
              you are a professional caregiver, family member, or someone
              seeking a deeper understanding of the end-of-life process, this
              course will provide you with the tools and mindset needed to
              navigate this profound journey with grace and compassion. Classes
              will take place at Gateway Home each Wednesday evening starting
              September 18th from 6:00-8:00 pm. Space is limited to ensure a
              personalized and intimate experience for all participants.
            </p>
            <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        <Card>
          ...
          <CardContent>
            <p className="leading-7 [&:not(:first-child)]:mt-6">
              Join us on Saturday, September 28, 2024, for an exciting evening
              at the Alexander Firemen’s Recreation Hall, located at 10708
              Alexander Rd, Alexander, NY 14011. Doors will open at 6:00 pm,
              with the first spin taking place promptly at 7:00 pm.
            </p>
            <p className="leading-7 [&:not(:first-child)]:mt-6">
              Presale tickets are available for $10.00 each or $80.00 for a
              table of 8. Tickets at the door will be $15.00. Each ticket
              includes one chance for the door prize, a slice of pizza, and a
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
              This event is held to benefit Gateway Home Comfort Care, located
              at 91 Main Street, Attica, NY 14011. For more information, please
