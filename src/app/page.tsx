    ...
    <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription className="max-w-lg text-balance leading-relaxed">
            A list of frequently asked questions about Gateway Home.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p className="leading-7 [&:not(:first-child)]:mt-6">
            <strong>What are Palliative Care, Hospice and Comfort Care?</strong>
          </p>
          <p className="leading-7 [&:not(:first-child)]:mt-6">
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6">
            <strong>How is Gateway Home Funded?</strong>
          </p>
          <p className="leading-7 [&:not(:first-child)]:mt-6">
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6">
            <strong>Do you receive help from the government?</strong>
          </p>
          <p className="leading-7 [&:not(:first-child)]:mt-6">
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6">
            <strong>Who provides direct care at Gateway Home?</strong>
          </p>
          <p className="leading-7 [&:not(:first-child)]:mt-6">
            ...
            caregivers every four hours during our day and evening shifts so our
            caregivers come in renewed and refreshed. Our overnight shift from
            11-7 is usually manned by one caregiver. Interested individuals do
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6">
            <strong>Who is eligible for admission to Gateway Home?</strong>
          </p>
          <p className="leading-7 [&:not(:first-child)]:mt-6">
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6">
            <strong>Are volunteer opportunities available?</strong>
          </p>
          <p className="leading-7 [&:not(:first-child)]:mt-6">
